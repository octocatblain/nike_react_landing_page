    ...
    <footer className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base leading-7 text-white-400 font-montserrat sm:max-w-sm">
            ...
            your perfect size in Stores new your and Get rewards.
          </p>
            ...
            <div key={section}>
              ...
              <ul>
                {section.links.map((link) => (
                  <li
                    className="mt-3 text-white-400 leading-normal font-montserrat hover:text-slate-gray cursor-pointer"
                    key={link.name}
                  >
                    <a href="">{link.name}</a>
                  </li>
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="flex flex-1 justify-start items-center font-montserrat cursor-pointer gap-2">
          ...
          />
          <p>Copyright &mdash; All Rights Reserved</p>
        </div>
        <p className="font-montserrat cursor-pointer">Terms &amp; Conditions</p>
        <p>
          <a href="http://nike-rosy.vercel.app">I</a>
        </p>
      </div>
    </footer>
  );
